...
# test_metadata_path = ['/home2/kesavaraj.v/kesav/database/LibriPhrase/metadata/test_aug_1word_v2.csv',
#                   '/home2/kesavaraj.v/kesav/database/eval/metadata/LP_positive_and_easyNegative.csv',
#                   '/home2/kesavaraj.v/kesav/database/eval/metadata/LP_positive_and_hardNegative.csv',
#                   '/home2/kesavaraj.v/kesav/database/eval/metadata/google_train.xlsx',
#                   '/home2/kesavaraj.v/kesav/database/eval/metadata/qualcom_train.xlsx']

# test_audio_path = ['/scratch/kesav/database/LibriPhrase/LibriPhrase_diffspk_all/',
#                '/scratch/kesav/database/eval/',
#                '/scratch/kesav/database/eval/',
#                '/scratch/kesav/database/eval/google/',
#                '/scratch/kesav/database/eval/qualcomm/']
