...
#Usage
#python <script>.py <download data dir> <folder/language name> <snr_rejected path>
...
def value_snr(file):
   ...
   #      print('removing files with < 15 db snr')
   #      os.remove(file)
    return snr

# base_path = sys.argv[1]
# snr_rejected = sys.argv[3]#"../"+base_path+"snr_rejected"
# folder = sys.argv[2]
