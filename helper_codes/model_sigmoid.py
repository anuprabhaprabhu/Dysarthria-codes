...
#defining path
train_metadata_path = '/asr3/anuprabha/metadata/train_v1.csv'
val_metadata_path = '/asr3/anuprabha/metadata/val_v1.csv'
test_metadata_path = '/asr3/anuprabha/metadata/test_v1.csv'
#audio_path = '/scratch/kesav/database/LibriPhrase/LibriPhrase_diffspk_all/'
feat_path = '/asr3/anuprabha/feats/LibriPhrase_diffspk_all/audio_mfcc_feats/'
...
def get_data_from_filename(file_path, label):
   ...
   audio_feat = np.load(os.path.join(feat_path, filename))['text']
  # threshold=200
...
filepath = '/asr3/anuprabha/models/'
...
model.fit(train_dataset, validation_data=val_dataset, 
          workers=4,  shuffle=True, epochs=50, verbose=1)
