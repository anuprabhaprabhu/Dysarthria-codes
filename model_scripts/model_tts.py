...
#defining path
train_metadata_path = '/home2/harinie.s/kesav/dataset_scripts/train_v1.csv'
val_metadata_path = '/home2/harinie.s/kesav/dataset_scripts/val_v1.csv'
test_metadata_path = '/home2/harinie.s/kesav/dataset_scripts/test_v1.csv'
audio_feat_path = '/scratch/kesav_h/feats/LibriPhrase_diffspk_all/audio_mfcc_feats/'
text_feat_path = '/scratch/kesav_h/feats/LibriPhrase_diffspk_all/text_lstm_feats/'
...
with strategy.scope():     
    ...
    #                        f1_score])
    model = tf.keras.models.load_model('/home2/harinie.s/kesav/model_scripts/TTS_lstm_sigmoid/checkpoint_e34.h5',custom_objects={'f1_score':f1_score})

filepath = '/home2/harinie.s/kesav/model_scripts/TTS_lstm_sigmoid_test/'
